...
Contact
 ...
 `,h=document.createElement("div");h.innerHTML=T;const H=h.firstElementChild,I=`<nav class="dds__side-nav__wrapper" data-dds="side-nav" id="sidenav-346059066" aria-label="Side Navigation example">
...
</nav>`,g=document.createElement("div");g.innerHTML=I;const f=g.firstElementChild;const A=document.querySelector("main"),b=document.querySelector("#app"),F=document.querySelector("#header"),Y=document.querySelector("#footer");b.appendChild(H);F.appendChild(L);A.insertAdjacentElement("beforebegin",f);const y=document.createElement("div");y.innerHTML=`
<div class="bot">
 <div class="bot__responses__container">
   ...
   </div>`;b.appendChild(y.firstElementChild);Y.appendChild(k);q();DDS.SideNav(f);
